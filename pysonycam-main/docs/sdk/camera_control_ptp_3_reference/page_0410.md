...
| --- | --- | --- | --- | --- |
| PropertyCode | 1 | 2 | UINT16 | 0xD1CB |
...
| Value | Description |
| --- | --- |
| 0x01 | Standard Format |
| 0x02 | Date Format |

| Field | Field Order | Size (Bytes) | Datatype | Value |
| --- | --- | --- | --- | --- |
| PropertyCode | 1 | 2 | UINT16 | 0xD1CC |
| Datatype | 2 | 2 | UINT16 | 0x0002(UINT8) |
...
Summary
Get/Set the recording folder format.
Description
Field
Field Order
Size (Bytes)
...
Summary
Get the StreamSettingList Operation Enable Status
Description
Field
Field Order
Size (Bytes)
