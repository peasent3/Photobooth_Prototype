...
| --- | --- | --- | --- | --- |
| PropertyCode | 1 | 2 | UINT16 | 0xD1EA |
...
| Field | Field Order | Size (Bytes) | Datatype | Value |
| --- | --- | --- | --- | --- |
| PropertyCode | 1 | 2 | UINT16 | 0xD1EB |
| Datatype | 2 | 2 | UINT16 | 0x0002(UINT8) |
| Get/Set | 3 | 1 | UINT8 | 0x01(Get/Set) |
| IsEnabled | 4 | 1 | UINT8 | variable |
| Reserved | 5 | 1 | UINT8 | 0x00 |
...
Summary
Get/Set the subject recognition animal (still) tracking sensitivity.
Description
Field
Field Order
Size (Bytes)
...
Summary
Get/Set the subject recognition animal (still) detection sensitivity.
Description
Field
Field Order
Size (Bytes)
